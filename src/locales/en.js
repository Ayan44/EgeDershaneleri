export const en = {
  ...
  footer: {
    brand: {
      description: 'Professional educational center for studying abroad and exam preparation.',
    },
    social: {
      followUs: 'Follow us',
      instagram: 'Instagram',
  ...
  // Hero Section
  hero: {
    title: 'Build your future from today.',
    subtitle: 'With result-oriented preparation programs for SAT, YÖS, IELTS and more, we guide students to their target universities.',
    contact: 'Contact',
    about: 'About',
    chips: {
      exams: 'SAT / YÖS / IELTS',
      teachers: 'Professional teachers',
      results: 'Results-oriented program',
    },
  },
  ...
  contact: {
    ...
    page: {
      title: 'Contact',
      intro: 'You can use the information below to contact us. If you have any questions, you can contact us via WhatsApp or email.',
    },
    info: {
  ...
  about: {
    ...
    page: {
      title: 'About Us',
      intro: 'Detailed information about EGE Dershane, our teaching staff and frequently asked questions.',
    },
    navigation: {
      company: 'About EGE',
      gallery: 'Gallery',
    ...
    company: {
      title: 'About EGE Dershane',
      description: 'EGE Dershane is one of Azerbaijan\'s leading educational centers in the field of studying abroad and exam preparation. Since 2020, our center has been providing quality educational services to hundreds of students.',
      mission: {
        title: 'Our Mission',
        description: 'To provide high-quality education to our students and help them achieve their dreams of studying abroad.',
      },
      approach: {
        title: 'Our Approach',
        description: 'To make the educational process effective with individual approach, practical methods and modern technologies.',
      },
      results: {
        title: 'Our Results',
        description: 'Most of our students achieve high scores in target exams and get accepted to their desired universities.',
      },
    },
    gallery: {
      title: 'Gallery',
      description: 'Photos of EGE Dershane\'s activities, events and student successes.',
    },
    faq: {
      title: 'Frequently Asked Questions',
      description: 'Answers to the most frequently asked questions about our courses, payments and services.',
      questions: {
        registration: {
          question: 'How is course registration carried out?',
          answer: 'You can apply online through our website for course registration. You can contact us using our contact information and get detailed information.',
        },
        format: {
          question: 'In what format are the classes held?',
          answer: 'Our classes are held both online and offline. We provide an interactive platform for online classes, and offline classes are held in classrooms equipped with modern equipment.',
        },
        duration: {
          question: 'How long is the course duration?',
          answer: 'Course duration varies depending on the exam type and student\'s preparation level. SAT and IELTS courses usually last 3-6 months, but the duration can be adjusted with an individual approach.',
        },
        pricing: {
          question: 'How much are the tuition fees?',
          answer: 'Tuition fees vary depending on the course type, duration and teaching format (online/offline). Please contact us for detailed information.',
        },
        studyAbroad: {
        ...
        achievements: {
          ...
          answer: 'Most of our students show high results in target exams. For specific statistics, you can visit our Achievements page.',
        },
        schedule: {
          question: 'How is the class schedule organized?',
          answer: 'The class schedule is organized individually taking into account the student\'s current program and time opportunities. It is possible to organize classes on weekends and in the evenings.',
        },
        payment: {
          question: 'What are the payment terms?',
          answer: 'Payments can be made in installments. After the initial payment, the remaining amount can be divided throughout the course period.',
        },
      },
    },
  },
  ...
  studyAbroad: {
    ...
    hero: {
      ...
      subtitle: 'We provide comprehensive study abroad support from admission to visa, from settlement to adaptation. We provide professional assistance to help our students build a successful academic life abroad.',
    },
    process: {
      title: 'How does the study abroad process work?',
      steps: {
        consultation: {
          title: 'Initial consultation and profile analysis',
          description1: 'The student\'s academic indicators and goals are evaluated',
          description2: 'Suitable country and program options are discussed',
        },
        selection: {
          title: 'Suitable country and university selection',
          description1: 'Options suitable for the student\'s budget and academic level are presented',
          description2: 'Universities with the best admission chances are recommended',
        },
        preparation: {
          title: 'Document preparation and application',
          description1: 'All necessary documents are prepared professionally',
          description2: 'Official applications are sent to universities',
        },
        visa: {
          title: 'Admission and visa process',
          description1: 'Visa documents are prepared after acceptance letters are received',
          description2: 'Support is provided in embassy interviews and visa acquisition process',
        },
        relocation: {
          title: 'Relocation, settlement and adaptation support',
          description1: 'Airport pickup and accommodation',
          description2: 'Cultural adaptation and academic life support',
        },
      },
    },
    destinations: {
      ...
      countries: {
        turkey: {
          name: 'Turkey',
          description: 'Quality education, affordable prices and universities recognized for European standards.',
        },
        russia: {
          name: 'Russia',
          description: 'High-level education in technical and humanitarian fields, internationally recognized diplomas.',
        },
        china: {
          name: 'China',
          description: 'World-leading universities in technology and engineering fields and scholarship programs.',
        },
        usa: {
          name: 'USA',
          description: 'The world\'s most prestigious universities, extensive academic opportunities and career prospects.',
        },
        canada: {
          name: 'Canada',
          description: 'High-quality education system, multicultural environment and immigration opportunities.',
        },
        poland: {
          name: 'Poland',
          description: 'Education in European standards, low tuition fees and English-language programs.',
        },
      },
      note: 'We also provide study abroad support for other countries not listed on the website. Selections are made individually according to the student\'s goals and profile.',
    },
    audience: {
      title: 'Who is it suitable for?',
      items: {
        graduates: 'High school graduates',
        students: 'Bachelor / Master\'s degree seekers',
        diploma: 'Those who want to obtain a diploma abroad',
        parents: 'Parents (for their child)',
      },
    },
    faq: {
      title: 'Frequently Asked Questions',
      questions: {
        duration: {
          ...
          answer: 'The study abroad process takes 6-18 months depending on the country and program chosen by the student. Every stage from initial consultation to admission and visa process is carried out with professional support.',
        },
        language: {
          question: 'Is language proficiency mandatory?',
          answer: 'Some countries and programs require language certificates, but we also provide language training within our preparation programs. An individual approach is applied for each student\'s level.',
        },
        scholarships: {
          question: 'Are there scholarship opportunities?',
          answer: 'Yes, there are government and university scholarships in various countries. We identify the most suitable scholarship options according to the student\'s academic indicators and chosen program.',
        },
        documents: {
          question: 'What documents are needed?',
          answer: 'Main documents: certificate/diploma, language certificate, passport, medical report and proof of financial support. Specific requirements may differ for each country - full support is provided in document preparation.',
        },
      },
    },
  },
  ...
  teachers: {
    ...
    empty: {
      ...
      message: 'No teacher found matching your search criteria.',
      showAll: 'Show all teachers',
    },
    modal: {
      about: 'about',
      aboutTitle: 'About',
    ...
    data: {
      'malik-memmedov': {
        ...
        bio: 'Malik Mammadov is the Founder and Lead Mathematics Instructor of EGE Dershane. He is recognized as one of the key educational experts who has contributed to the development of a practical approach to mathematics education in Azerbaijan. With over 17 years of teaching experience, he has helped thousands of students view mathematics not merely as a subject, but as a tool for logical thinking and analytical problem-solving. Malik Mammadov specializes primarily in YÖS/TYS preparation, university entrance (abituriyent), and graduation exam preparation. His structured, result-oriented teaching methodology enables hundreds of students each year to achieve high scores and gain admission to their target universities. In his lessons, he places strong emphasis on practical problem-solving, clear logical explanations, and an individualized approach to each student. In addition to working with students, Malik Mammadov actively contributes to the professional development of teachers. He designs and delivers various teacher training and development programs, supporting higher teaching standards and the adoption of modern, effective mathematics teaching methods.',
      ...
      'fatime-gurbanzade': {
        ...
        bio: 'Fatima Gurban­zadeh is a professional language instructor specializing in SAT English, IELTS, and TOEFL preparation. She holds a degree from the Azerbaijan State University of Culture and Arts and has a strong academic background in international examination systems, which allows her to guide students effectively through globally recognized language assessments. With over 6 years of teaching experience, Fatima has supported thousands of students in achieving the language proficiency required for admission to foreign universities. In addition to English, she also provides high-level German language instruction, preparing students for both academic and general language goals. Fatima Gurban­zadeh is well known for her individualized teaching approach and practical, exam-focused methods. She prioritizes building students’ confidence, communication skills, and test strategies, ensuring measurable progress and successful outcomes.',
        specialties: ['SAT (English)', 'IELTS', 'TOEFL', 'German Language'],
      },
      'gulyaz-mesediyev': {
        fullName: 'Gulyaz Meshediyeva',
        role: 'Azerbaijani Language / Literature',
        bio: 'Gulyaz Mashadiyeva is a professional instructor specializing in Azerbaijani language and literature. She earned her degree in Philology from Baku Slavic University, where she developed a strong academic foundation in linguistics and literary studies, enabling her to present complex topics in a clear and structured manner. Gulyaz has an in-depth understanding of the national examination system and applies a practical, results-oriented teaching approach in her lessons. She focuses on clear explanations, systematic practice, and regular revision to help students strengthen their language skills and perform confidently in exams. In addition, she successfully teaches Azerbaijani language to students from the Russian-language education sector, addressing their specific learning needs. With over 6 years of teaching experience, Gulyaz Mashadiyeva is dedicated to helping each student reach their full potential. Her lessons aim not only at exam success but also at fostering a deeper appreciation of the Azerbaijani language and literary heritage.',
        specialties: ['Azerbaijani Language', 'Literature'],
      },
      'aygun-mirzeyeva': {
        fullName: 'Aygun Mirzayeva',
        role: 'English Language',
        bio: 'Aygun Mirzayeva is an English language instructor focused on developing students’ overall language proficiency. In her lessons, she emphasizes a balanced improvement of speaking, writing, reading, and listening skills, ensuring that students build a strong and practical foundation in English. She does not limit her teaching to theory alone; instead, Aygun encourages creative thinking and confident self-expression in English. Through interactive activities, discussions, and practical exercises, she helps students actively use the language rather than simply memorize rules. Her goal is to enable students to communicate effectively in English in both everyday and academic contexts. A supportive learning environment and an individualized approach are key elements of Aygun Mirzayeva’s teaching style.',
        specialties: ['English Language', 'Speaking', 'Writing', 'Reading', 'Listening'],
      },
      'ismayil-haqverdiyev': {
        fullName: 'Ismail Hagverdiyev',
        role: 'YÖS / TYS',
        bio: 'Ismayil Hagverdiyev is a professional mathematics instructor specializing in YÖS and TYS preparation. He has strong expertise in combinatorics, geometry, probability theory, and logical problem-solving, areas that require advanced analytical thinking and structured reasoning. In his teaching, Ismayil goes beyond theoretical explanations and focuses on developing students’ analytical and creative thinking skills. His lessons are based on clear explanations of complex topics and consistent practice with exam-oriented and olympiad-style problems. In addition to mathematics olympiad preparation, he also supports students preparing for SAT, YÖS/TYS, abituriyent, and graduation exams. His goal is to help students achieve strong exam results while building a solid mathematical mindset and problem-solving strategy.',
  ...
  blogPreview: {
    label: 'Blog',
    title: 'Latest posts',
    description: 'Get acquainted with the latest news, tips and success stories in the field of education.',
    category: 'Education',
    viewAll: 'View all',
  },
  ...
  studyAbroadComponent: {
    ...
    services: {
      ...
      scholarships: 'Scholarship and admission strategy',
      visaGuidance: 'Visa guidance',
      educationPlan: 'Education plan and roadmap',
      ongoingSupport: 'Ongoing support and monitoring',
    },
    buttons: {
  ...
  achievements: {
    ...
    universities: {
      ...
      adnan: "Adnan Menderes University",
      iskenderun: "Iskenderun Technical University",
      zonguldak:"Zonguldak Bülent Ecevit University"
    },
    successStoriesData: {
      sureyya: {
        name: 'Sureyya Zulfugarli',
        beforeAfter: 'Weak English → IELTS 8.5',
        story: 'When Surayya joined our preparation program, her mathematics foundation was at a very basic level. After 19 months of intensive and structured training, she achieved a score of 481 points in a YÖS mock exam, demonstrating significant academic progress. She is currently continuing her studies within the preparation program.',
        highlights: {
          duration: '19 months',
      ...
      zehra: {
        name: 'Zehra Mahmudzade',
        beforeAfter: 'English 40 → 73',
        story: 'Zahra had a strong foundation in grammar but faced challenges in listening comprehension. Through our targeted strategies, she increased her English score in graduation exam mock tests from 40 to 75. We are confident that she will achieve even higher results in upcoming mock exams.',
        highlights: {
          duration: '12 months',
          type: 'Graduation preparation',
          program: 'Group Classes',
        },
      },
      rena: {
        name: 'Rana Amanova',
        beforeAfter: 'Graduation Preparation 52 → 119',
        story: 'Rana aims to gain admission to the Interior Design program and is currently preparing for graduation subjects at our course. Through our structured preparation approach, she increased her mock exam score from 52 to 119, demonstrating strong academic progress. We are confident that she will continue to improve her results by the time of the official exam.',
        highlights: {
          duration: '4 months',
          type: 'Graduation preparation',
          program: 'Design faculty',
        },
      },
    },
    categories: {
