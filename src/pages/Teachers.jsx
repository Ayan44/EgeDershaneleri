    ...
    <main className="container page">
      <div className="pageContentAbout">
        <header className="pageHeader">
          ...
          Təcrübəli və peşəkar müəllimlərimiz komandası ilə tələbələrimizə ən yaxşı təhsil təcrübəsini təqdim edirik.
        </p>
        </header>
      ...
      <section className="teachers-grid">
        {filteredTeachers.length > 0 ? (
          ...
          <div className="teachers-empty">
            ...
            <p>Axtardığınız kriteriyalara uyğun müəllim tapılmadı.</p>
      ...
      <Modal
        ...
        title={`${selectedTeacher?.fullName || ''} haqqında`}
        size="large"
      >
        {selectedTeacher && (
