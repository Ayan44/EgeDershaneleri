...
import '../sections/DomeGallery.css';
...
function buildItems(pool, seg) {
  ...
  // Note: If pool.length > totalSlots, some images will not be shown
  // This is expected behavior and doesn't need logging in production
